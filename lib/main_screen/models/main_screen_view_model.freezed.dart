...
abstract class $MainScreenViewModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({double allAmount, List<ExpenseViewModel> expenses});
}
...
class _$_MainScreenViewModel implements _MainScreenViewModel {
  const _$_MainScreenViewModel(
      {required this.allAmount, required final List<ExpenseViewModel> expenses})
      : _expenses = expenses;
  ...
  @override
  String toString() {
    return 'MainScreenViewModel(allAmount: $allAmount, expenses: $expenses)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, allAmount, const DeepCollectionEquality().hash(_expenses));
...
abstract class _MainScreenViewModel implements MainScreenViewModel {
  const factory _MainScreenViewModel(
      ...
      required final List<ExpenseViewModel> expenses}) = _$_MainScreenViewModel;
