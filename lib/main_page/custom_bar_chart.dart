...
final expences = <ExpenceViewModel>[
  ExpenceViewModel(
    name: 'Pen',
    category: ExpenceCategory.clothes,
    price: 100,
    date: DateTime.parse('10/02/2022'),
  ),
  ExpenceViewModel(
    name: 'Restaurant',
    category: ExpenceCategory.fun,
    price: 150,
    date: DateTime.parse('10/02/2022'),
  ),
  ExpenceViewModel(
    name: 'Bread',
    category: ExpenceCategory.food,
    price: 20,
    date: DateTime.parse('10/02/2022'),
  ),
  ExpenceViewModel(
...
class _CustomBarChartState extends State<CustomBarChart> {
  ...
  void initState() {
    ...
    showingBarGroups = expences.map((e) => makeColumnData(
          index++,
        ));
